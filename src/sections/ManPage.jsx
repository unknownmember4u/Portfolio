    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
        <div>
          ...
          <p style={{ marginBottom: '1rem' }}>
            Beyond infrastructure, I have developed end-to-end machine learning projects featuring automated retraining cycles and seamless cloud storage integrations. I hold a strong foundation in Linux administration and system monitoring tools like AWS and Ansible.
          </p>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
            {['Cloud Infrastructure', 'CI/CD Automation', 'Machine Learning', 'Linux SysAdmin'].map(tag => (
              <span key={tag} style={{
